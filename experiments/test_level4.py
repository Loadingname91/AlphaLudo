"""
Quick test script for Level 4 environment.
...
def main():
    print("\n" + "="*80)
    print("LEVEL 3 ENVIRONMENT TEST SUITE (Six-to-Exit Rule)")
    print("="*80)
    ...
    try:
        ...
        print("="*80)
        print("\nLevel 4 environment is ready for training!")
        print("Run: python experiments/level4_train.py")
